...
set :website_url, 'http://silverstripe-capistrano.mattrayner.co.uk'
...
set :curl_command, 'http://silverstripe-capistrano.mattrayner.co.uk/?flush=all&env_type=dev'
...
server 'silverstripe-capistrano.mattrayner.co.uk', user: 'root', roles: %w{web app db}
