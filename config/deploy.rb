...
set :application, 'my-silverstrpe-project'
set :repo_url, 'git@github.com:mattrayner/my-silverstripe-project.git'

# Default branch is :master
# ask :branch, proc { `git rev-parse --abbrev-ref HEAD`.chomp }

# Default deploy_to directory is /var/www/APPLICATION_NAME
set :deploy_to, '/var/www/my-silverstripe-project'
...
set :linked_files, %w{mysite/_config.php mysite/_config/config.yml _ss_environment.php .htaccess}
